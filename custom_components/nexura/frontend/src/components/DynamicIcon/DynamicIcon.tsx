...
export const DynamicIcon: React.FC<DynamicIconProps> = ({ name, size = 24, color, className }) => {
    // @ts-expect-error - Accessing LucideIcons object by string key
    const IconComponent = (LucideIcons as Record<string, React.ElementType>)[name] || LucideIcons.HelpCircle;
